import { i as speakJapanese, o as stopSpeaking, r as ensureVoices, s as cn, t as useProgress } from "./store-BeK7TWEZ.js";
...
import { BarChart3, BookOpen, CalendarDays, Ear, Ellipsis, Home, Languages, MessageCircle, Mic, RotateCcw, Settings, TriangleAlert, Volume2 } from "lucide-react";
import { z } from "zod";
...
function AppShell({ children }) {
	...
	if (immersive) return /* @__PURE__ */ jsx(Fragment, { children });
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			/* @__PURE__ */ jsxs("header", {
				...
				children: [/* @__PURE__ */ jsx(Seal, {}), /* @__PURE__ */ jsxs("div", {
					className: "min-w-0",
...
//#endregion
//#region src/components/art/scene.tsx
var paper = "#f3eee6";
var ink = "#1c1916";
var indigo = "#3d5a7a";
var clay = "#6b635a";
...
function SceneArt({ art, className }) {
	switch (art) {
		case "morning": return /* @__PURE__ */ jsxs(Frame, {
			className,
			children: [
				/* @__PURE__ */ jsx("rect", {
					x: "0",
		...
		case "day": return /* @__PURE__ */ jsxs(Frame, {
			className,
			children: [
				/* @__PURE__ */ jsx("rect", {
					width: "320",
		...
		case "night": return /* @__PURE__ */ jsxs(Frame, {
			className,
			children: [
				/* @__PURE__ */ jsx("rect", {
					width: "320",
		...
		case "meet": return /* @__PURE__ */ jsxs(Frame, {
			className,
			children: [
				/* @__PURE__ */ jsx("rect", {
					width: "320",
		...
		case "introduce": return /* @__PURE__ */ jsxs(Frame, {
			className,
			children: [
				/* @__PURE__ */ jsx("circle", {
					cx: "160",
		...
		case "thisis": return /* @__PURE__ */ jsxs(Frame, {
			className,
			children: [
				/* @__PURE__ */ jsx("rect", {
					x: "36",
		...
		case "family": return /* @__PURE__ */ jsxs(Frame, {
			className,
			children: [/* @__PURE__ */ jsx("rect", {
				x: "40",
				y: "120",
				...
				178,
				224
			].map((x, i) => /* @__PURE__ */ jsxs("g", { children: [/* @__PURE__ */ jsx("circle", {
				cx: x,
				cy: "78",
				r: i === 1 ? 16 : 14,
		...
		case "home": return /* @__PURE__ */ jsxs(Frame, {
			className,
			children: [
		...
		case "eat": return /* @__PURE__ */ jsxs(Frame, {
			className,
			children: [
				/* @__PURE__ */ jsx("ellipse", {
					cx: "160",
		...
		case "drink": return /* @__PURE__ */ jsxs(Frame, {
			className,
			children: [
				/* @__PURE__ */ jsx("rect", {
					x: "132",
		...
		case "go": return /* @__PURE__ */ jsxs(Frame, {
			className,
			children: [
				/* @__PURE__ */ jsx("rect", {
					x: "0",
		...
		case "return": return /* @__PURE__ */ jsxs(Frame, {
			className,
			children: [
				/* @__PURE__ */ jsx("rect", {
					width: "320",
		...
		case "shop": return /* @__PURE__ */ jsxs(Frame, {
			className,
			children: [
				/* @__PURE__ */ jsx("rect", {
					x: "50",
		...
		case "ask": return /* @__PURE__ */ jsxs(Frame, {
			className,
			children: [
				/* @__PURE__ */ jsx("rect", {
					x: "0",
		...
		case "time": return /* @__PURE__ */ jsxs(Frame, {
			className,
			children: [
				/* @__PURE__ */ jsx("circle", {
					cx: "160",
		...
		case "numbers": return /* @__PURE__ */ jsx(Frame, {
			className,
			children: [
				0,
				1,
		...
		case "school": return /* @__PURE__ */ jsxs(Frame, {
			className,
			children: [
				/* @__PURE__ */ jsx("rect", {
					x: "50",
		...
		case "daily": return /* @__PURE__ */ jsxs(Frame, {
			className,
			children: [
				/* @__PURE__ */ jsx("circle", {
					cx: "56",
		...
		case "week": return /* @__PURE__ */ jsx(Frame, {
			className,
			children: [
				0,
				1,
		...
		case "food": return /* @__PURE__ */ jsxs(Frame, {
			className,
			children: [
				/* @__PURE__ */ jsx("ellipse", {
					cx: "160",
		...
		case "like": return /* @__PURE__ */ jsxs(Frame, {
			className,
			children: [
				/* @__PURE__ */ jsx("rect", {
					x: "0",
		...
		case "weather": return /* @__PURE__ */ jsxs(Frame, {
			className,
			children: [
				/* @__PURE__ */ jsx("circle", {
					cx: "90",
		...
		default: return /* @__PURE__ */ jsx(Frame, {
			className,
			children: /* @__PURE__ */ jsx("rect", {
				x: "70",
				y: "50",
...
//#endregion
//#region src/components/lesson/audio-bar.tsx
var unlocked = false;
...
function AudioBar({ ja, auto, size = "default" }) {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsxs(Button, {
			...
			children: [/* @__PURE__ */ jsx(Volume2, { className: "ml-0.5" }), "Listen"]
			...
			children: [/* @__PURE__ */ jsx(RotateCcw, {}), size === "lg" ? "Again" : null]
		})]
	});
}
//#endregion
...
function Onboarding() {
	...
	if (step === 0) return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsxs("div", {
			...
			children: [
				/* @__PURE__ */ jsx(Seal, { className: "size-12" }),
				/* @__PURE__ */ jsx("h1", {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				/* @__PURE__ */ jsx(SceneArt, { art: "morning" }),
				/* @__PURE__ */ jsx("p", {
					className: "text-sm leading-relaxed text-muted-foreground",
				...
				/* @__PURE__ */ jsx(AudioBar, {
					ja: "おはよう。",
					size: "lg"
				}),
				!revealed ? /* @__PURE__ */ jsx(Button, {
					variant: "outline",
					className: "w-full",
					...
					children: [/* @__PURE__ */ jsx("p", { children: "Good morning." }), /* @__PURE__ */ jsx("p", {
...
function Root() {
	return /* @__PURE__ */ jsxs("html", {
		...
		children: [/* @__PURE__ */ jsx("head", { children: /* @__PURE__ */ jsx(HeadContent, {}) }), /* @__PURE__ */ jsxs("body", { children: [
			...
			/* @__PURE__ */ jsx(AuthProvider, { children: /* @__PURE__ */ jsx(ShellGate, {}) }),
...
function ShellGate() {
	...
	if (!onboardingDone) return /* @__PURE__ */ jsx(Onboarding, {});
	return /* @__PURE__ */ jsx(AppShell, { children: /* @__PURE__ */ jsx(Outlet, {}) });
}
//#endregion
//#region src/routes/index.tsx
var $$splitComponentImporter$14 = () => import("./routes-C33HYMhm.js");
...
var $$splitComponentImporter$8 = () => import("./learn-CgpTVMAO.js");
var Route$8 = createFileRoute("/learn")({ component: lazyRouteComponent($$splitComponentImporter$8, "component") });
//#endregion
//#region src/routes/listen.tsx
var $$splitComponentImporter$7 = () => import("./listen-DAXUDnV4.js");
...
var $$splitComponentImporter$6 = () => import("./more-CKzaq4nO.js");
...
var $$splitComponentImporter$5 = () => import("./progress-DpKUxXVo.js");
...
var $$splitComponentImporter$4 = () => import("./review-Cq6Ya4OV.js");
...
var $$splitComponentImporter$3 = () => import("./settings-CkXB4jg1.js");
...
var $$splitComponentImporter$2 = () => import("./speak-Utftv4du.js");
var Route$2 = createFileRoute("/speak")({ component: lazyRouteComponent($$splitComponentImporter$2, "component") });
//#endregion
//#region src/routes/dialogue.$id.tsx
var $$splitComponentImporter$1 = () => import("./dialogue._id-4AWlUjFR.js");
...
var $$splitComponentImporter = () => import("./lesson._id-BiRvgNk3.js");
...
//#endregion
export { Input as a, unlockSpeech as c, moreLinks as d, getRouter, Label as i, SceneArt as l, Route as n, AudioBar as o, Route$1 as r, speechUnlocked as s, router_exports as t, Page as u };
